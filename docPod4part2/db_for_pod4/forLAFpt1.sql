...
--
-- Host: localhost
-- Generation Time: Dec 08, 2012 at 09:00 AM
...
INSERT INTO `item` (`id`, `title`, `state`, `user_id`, `item_type_id`, `description`, `spot`, `street`, `city`, `zip`, `country_id`, `created`, `is_found`) VALUES(1, 'Blue Umbrella', NULL, 4, 3, 'I think i left it in the Costa Coffee.', NULL, NULL, NULL, NULL, 3, NULL, 0);
INSERT INTO `item` (`id`, `title`, `state`, `user_id`, `item_type_id`, `description`, `spot`, `street`, `city`, `zip`, `country_id`, `created`, `is_found`) VALUES(2, 'Car Key', NULL, 1, 2, 'PLEASE return them, my aunt is locked in my ferrari.', NULL, NULL, NULL, NULL, 1, NULL, 0);
INSERT INTO `item` (`id`, `title`, `state`, `user_id`, `item_type_id`, `description`, `spot`, `street`, `city`, `zip`, `country_id`, `created`, `is_found`) VALUES(3, 'Wallet with $500 Inside', NULL, 4, 1, 'I am on a holiday in Germany and I''ve lost my money. Please keep the money but return my driver license.', NULL, NULL, NULL, NULL, 88, NULL, NULL);
INSERT INTO `item` (`id`, `title`, `state`, `user_id`, `item_type_id`, `description`, `spot`, `street`, `city`, `zip`, `country_id`, `created`, `is_found`) VALUES(4, 'Girlfriend', NULL, 2, 2, 'aoeu', NULL, NULL, NULL, NULL, 8, NULL, 1);
...
INSERT INTO `user` (`id`, `is_admin`, `first_name`, `last_name`, `company`, `email`, `password`, `created`) VALUES(7, 0, NULL, NULL, NULL, 'user1@website.com', '', NULL);
